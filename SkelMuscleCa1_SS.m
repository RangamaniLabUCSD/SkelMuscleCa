...
if freq == 0
    options = odeset('RelTol',1e-8,'NonNegative',[1:5,7:17]);
else
...
% ode rate
    function dydt = f(t,y,p,freq,lowATP)
        ...
        % 
        % if freq > 0
        %     % LumpedJ_SERCA = 0.5 * LumpedJ_SERCA;
        ...
        Nf = [1;1000;1;1;1;100;1000;1000;0.1;1;1;1;1;100000;500;1000;1]; %Normalization factor
